...
class CustomUser(AbstractUser):
    ...
    PERMISSION_CHOICES = (
        ...
        ("ACCESS_LIFTS", "Access Lifts"),
        ("ACCESS_ITEMS", "Access Items"),
        ("ACCESS_CUSTOMER_LICENSE", "Access Customer License"),
        ("ACCESS_AMC", "Access AMC"),
        ("ACCESS_AMC_THIS_MONTH_EXPIRE", "Access This Month Expire"),
        ("ACCESS_AMC_LAST_MONTH_EXPIRE", "Access Last Month Expire"),
        ("ACCESS_AMC_NEXT_MONTH_EXPIRE", "Access Next Month Expire"),
        #("ACCESS_SALES", "Access Sales"),
        ("ACCESS_CUSTOMERS", "Access Customers"),
        ("ACCESS_DELIVERY_CHALLAN", "Access Delivery Challan"),
        ("ACCESS_QUOTATION", "Access Quotation"),
        ("ACCESS_ORDERS", "Access Orders"),
        ("ACCESS_INVOICE", "Access Invoice"),
        ("ACCESS_PAYMENT_RECEIVED", "Access Payment Received"),
        ("ACCESS_RECURRING_INVOICES", "Access Recurring Invoices"),
        #("ACCESS_ROUTINE_SERVICES", "Access Routine Services"),
        ("ACCESS_TODAY_SERVICES", "Access Today Services"),
        ("ACCESS_ROUTE_WISE_SERVICES", "Access Route Wise Services"),
        ("ACCESS_THIS_MONTH_SERVICES", "Access This Month Services"),
        ("ACCESS_LAST_MONTH_SERVICES", "Access Last Month Services"),
        ("ACCESS_THIS_MONTH_OVERDUE", "Access This Month Overdue"),
        ("ACCESS_LAST_MONTH_OVERDUE", "Access Last Month Overdue"),
        ("ACCESS_LAST_MONTH_COMPLETED", "Access Last Month Completed"),
        ("ACCESS_THIS_MONTH_COMPLETED", "Access This Month Completed"),
        ("ACCESS_PENDING_ASSIGN", "Access Pending Assign"),
        ("ACCESS_COMPLAINTS", "Access Complaints"),
        ("ACCESS_MONTHLY_LOAD", "Access Monthly Load"),
        ("ACCESS_SERVICES_SCHEDULE", "Access Services Schedule"),
        ("ACCESS_MATERIAL_REQUEST", "Access Material Request"),
        #("ACCESS_INVENTORY", "Access Inventory"),
        ("ACCESS_REQUISITION", "Access Requisition"),
        ("ACCESS_STOCK_REGISTER", "Access Stock Register"),
        ("ACCESS_REPORTS", "Access Reports"),
        # Retained original permissions for actions
